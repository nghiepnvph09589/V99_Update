...
const getTabBarIcon = (navigation, focused, tintColor) => {
    ...
    const iconSource = focused && tabbarIconsActive[routeName] ||
        tabbarIcons[routeName] || R.images.ic_tab_home
    const iconSize = 20
    return (
        <View
            style={{
            ...
            return (
                <TabBarComponent
                    ...
                    onTabPress={async (route) => {
                        if (route.route.key == SCREEN_ROUTER.HOME || route.route.key == SCREEN_ROUTER.PRODUCT) {
