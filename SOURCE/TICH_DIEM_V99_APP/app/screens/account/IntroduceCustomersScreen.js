...
import {
    FlatList, RefreshControl, SafeAreaView, View,
    Text,
    StyleSheet
} from 'react-native'
...
import {
    Block, CartItem, DCHeader, Empty, Error, Loading,
} from '../../components'
...
export class IntroduceCustomersScreen extends Component {
    ...
    renderBody() {
        ...
        return (<FlatList
            ...
            ListHeaderComponent={<View style={styles.header_list}>
                <Text style={{
                    flex: 1,
                    ...styles.text_header
                }}>STT</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(IntroduceCustomersScreen)
