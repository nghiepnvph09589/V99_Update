...
class AppContainer extends Component {
  constructor(properties) {
    super(properties);
    OneSignal.init("9e9fbbde-ba5c-42af-9c08-7888f0709c4a"); // ios
  ...
  async onReceived(notification) {
    ...
    switch (type) {
      ...
      case NOTIFY_NAVIGATE.ORDER_DETAIL: {
        ...
        if (data.StatusOrder == ORDER.PAID)
          this.props.updateUserLocal({ pointRanking: data.PointRaking });
        break;
      }
      ...
      case NOTIFY_NAVIGATE.ORDER_DETAIL: {
        ...
        NavigationUtil.reset({
          ...
          actions: [
            ...
            NavigationUtil.replace(SCREEN_ROUTER.DETAIL_ORDER, {
              orderID: orderID,
              code: code
            })
          ]
