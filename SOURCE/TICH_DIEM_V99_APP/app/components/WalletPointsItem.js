...
class WalletPointsItem extends Component {
  render() {
    ...
    const userAction =
      item.type == ACTION_POINTS_TYPE.AWARDED_POINTS
        ? "Người gửi: "
        : "Người nhận: ";
    // console.log(item)
    return (
      ...
      >
        ...
        >
          {DateUtil.formatTime(item.createDate)}{" "}
        ...
        <View
          style={[
            ...
            (item.type == ACTION_POINTS_TYPE.AWARDED_POINTS ||
              item.type == ACTION_POINTS_TYPE.MOVING_POINTS) && {
        ...
        >
          <View
            style={{ flex: 1, paddingHorizontal: "2.5%", paddingVertical: 10 }}
          >
            <Text
              style={{
