...
import {
  ...
  GET_WARRANTY, GET_WARRANTY_SUCCESS,
  GET_WARRANTY_FAIL, GET_IMAGE_SUCCESS,
  GET_IMAGE_FAIL, GET_IMAGE,
  GET_WALLET_ACCUMULATE_POINTS,
  GET_WALLET_ACCUMULATE_POINTS_SUCCESS,
  GET_WALLET_ACCUMULATE_POINTS_FAIL,
  GET_WALLET_POINTS,
  GET_WALLET_POINTS_SUCCESS,
  GET_WALLET_POINTS_FAIL,
  GET_HISTORY_DRAW_POINTS,
  GET_HISTORY_DRAW_POINTS_SUCCESS,
  GET_HISTORY_DRAW_POINTS_FAIL,
  GET_BANK_SELECT,
  GET_BANK_SELECT_SUCCESS,
  GET_BANK_SELECT_FAIL,
  GET_BANK_SUCCESS,
  GET_BANK_FAIL,
  GET_BANK,
  GET_HISTORY_MOVING_POINTS,
  GET_HISTORY_MOVING_POINTS_SUCCESS,
  GET_HISTORY_MOVING_POINTS_FAIL,
  GET_LIST_POINT_V,
...
export function* getListPointV(action){
  try {
    const response = yield call(API.requestListHistoryPointMember,action.payload);
    yield put({
      type: GET_LIST_POINT_V_SCUCCESS,
      payload: response.data
    })
  } catch (err) {
    yield put({type: GET_LIST_POINT_V_FAIL, payload: err})
  }
}
...
export const watchFetchGetListPontV = takeEvery(GET_LIST_POINT_V, getListPointV);